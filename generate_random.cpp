...
int main()
{
    ...
    */
    ...
    answer = "The output is a sequence of 10 random number between 0 and RAND_MAX" ; // 1. Write your answer to Q1 in between " "
    ...
    answer = "The ouput is a 10 numbers between 0 and 4 which is the range of values for the remainder" ; // 2. Write your answer to Q2 in between " "
    ...
    answer = "The output of rand()%5+3 is the remainder of the divison between a random number and 5, after this the remainder is added with 3 thus providing a number between 3-7" ; // 3. Write your answer to Q3 in between " "
    ...
    answer = "when you remove srand(time(null)), the program generates the same sequence of numbers twice because the algorithm is using the same seed value" ; // 4. Write your answer to Q4 in between " "
